# # # # # New Features
# # # # 1. Added Strength Potions, you start with 2, they have a 1/20(5%) chance to drop and they increase player dmg by 20 for 3 turns

# # # # # Bug Fixes
# # # # 1. 

# # # # # Other Changes
# # # # 1. Changed critical chance to 1/4(25%)
# # # # 2. Changed critical token chance to 1/10(10%)

# # # # # Change In Code
# # # # 1. Changed instance B to the Strength Potion
# # # # 1. Added instance C, the Critical Token

# # # # # # # Lines of code: 242 ( + 84 )
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
            ...
            if (use == "1"):
                ...
                if (C.num > 0):
                    ...
                    C.num = C.num - 1
                    print(f"You used a Critical Token! It increased your critical damage by 30!")
