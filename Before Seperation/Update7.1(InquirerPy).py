# # # # # Plans For Future
# # # # 1. Using the os module as the console.clear() method.
...
# # # # # # # Lines of code: 265 ( + 63 )

import random as r
from time import sleep
from InquirerPy import prompt
# Unanswered questions:
# 1. What was fixed in the bug fixes section? 
# 2. What changes were made in the 'Other Changes' section? 
class Enemy:
    global enemy
    enemy = []
    ...
    stats = [
        {
            "name": "stata",
            "type": "list",
            "choices": ["Check my Stats", "Just Start the Game"],
