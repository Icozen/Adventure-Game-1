...
# # # # # New Features
# # # # 1. The "Console Clear" setting clears the history of the previous enemy killed.
# # # # 2. A soundtrack in the form of a mp3 file which tells whether the above setting is on or not.

# # # # # Bug Fixes
# # # # 1. Fixed Bug ID B (Used to say the amount of health potions when acquiring a critical token)
# # # # 2. Fixed Bug ID C (Wasn't dropping items other than critical tokens)
                    ...
                    if (PlayerHP <= 0 and aa.hp <= 0):
                        ...
                        if (c == "Continue"):
                            ...
                            if (Chance100 > healthpotion.perc):
                                ...
                                # B.num = B.num + 1
                                B.num += 1
                                print(f"The enemy dropped a Strength Potion! You now have {C.num} Strength Potions!")
                                print(f"You encountered a {eencountered}!")
                            elif (Chance100 <= crittoken.perc):
                                aa.hp = 70
                                # C.num = C.num + 1
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
                ...
                if (use == "Health Potion"):
                    ...
                    if (B.num > 0):
                        ...
                        print("You don't have any Strength Potions left!")
                    pass
