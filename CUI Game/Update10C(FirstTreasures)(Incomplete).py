...
################################# SIR KHURRAMS ASKARI ADDRESS: HOUSE 225
...
class Treasure(Item):
    def __init__(self, name, rarity, hpincrease, hpcapincrease, dmgincrease, dmgmultiplier, critchanceincrease, critdmgincrease, defenseincrease):
        super.__init__(self, name, hpincrease, hpcapincrease, dmgincrease, dmgmultiplier, critchanceincrease, critdmgincrease, defenseincrease)
        self.rarity = rarity
...
A = Item("Health Potion", 3, 25, 0, 0, 0, 0, 0, 0,)
A.addInBag()
...
PerfectTreasureMap = Treasure("PerfectTreasureMap", 15, 1.2, 10, 1.2, 10, 50, 100)

# # # # # Treasure Functions
# # # 1. Perfect Treasure Map
def perfect_treasure_map():
    PTMStatBuff = r.randint(1, 7)
    if PTMStatBuff == 1:
        PlayerHP += PerfectTreasureMap.hpincrease
    elif PTMStatBuff == 2:
        pass
    elif PTMStatBuff == 3:
        PlayerDMG += PerfectTreasureMap.dmgincrease
    elif PTMStatBuff == 4:
        PlayerDMG = PlayerDMG * PerfectTreasureMap.dmgmultiplier
    elif PTMStatBuff == 5:
